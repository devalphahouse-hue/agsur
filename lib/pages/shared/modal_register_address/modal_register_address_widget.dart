...
class _ModalRegisterAddressWidgetState
    extends State<ModalRegisterAddressWidget> {
  ...
  Widget build(BuildContext context) {
    return AppModal(
      ...
      description: 'Informe o CEP — preenchimento automático de cidade/UF.',
      maxWidth: 720,
      footer: Row(
        ...
        child: Column(
          ...
          children: [
            AppFormField(
              ...
              helper: 'Endereço, cidade e UF são preenchidos automaticamente.',
              onChanged: _onCepChanged,
              validator: (v) =>
                  _model.tFZipCodeTextControllerValidator?.call(context, v),
            ),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: AppFormField(
                    ...
                    required: true,
                    validator: (v) =>
                        _model.tFufTextControllerValidator?.call(context, v),
                  ),
                ),
              ],
            ),
