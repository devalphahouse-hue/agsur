...
class ViewEditPilotsWidget extends StatefulWidget {
  const ViewEditPilotsWidget({
    super.key,
  ...
  static String routeName = 'ViewEditPilots';
  static String routePath = '/viewEditPilots';

  @override
  State<ViewEditPilotsWidget> createState() => _ViewEditPilotsWidgetState();
}

class _ViewEditPilotsWidgetState extends State<ViewEditPilotsWidget> {
  late ViewEditPilotsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewEditPilotsModel());
                    ...
                    child: Column(
                      ...
                      children: [
                                                      ...
                                                      TextFormField(
                                                        ...
                                                        cursorColor:
                                                            FlutterFlowTheme.of(
                                                                ...
                                                                .secondaryBackground,
                                                        validator: _model
                                                            .tFLastNameTextControllerValidator
                                                            .asValidator(
                                                                context),
                                                      ),
                                                    ].divide(
                                                      ...
                                                      TextFormField(
                                                        ...
                                                        cursorColor:
                                                            FlutterFlowTheme.of(
                                                                ...
                                                                .secondaryBackground,
                                                        validator: _model
                                                            .tFEmailPilotTextControllerValidator
                                                            .asValidator(
                                                                context),
                                                      ),
                                                    ].divide(
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              16.0, 24.0, 16.0, 24.0),
                          child: FutureBuilder<List<PilotCertificatesViewRow>>(
                            future: (_model.requestCompleter ??=
                                    Completer<List<PilotCertificatesViewRow>>()
                                      ..complete(PilotCertificatesViewTable()
                                          .queryRows(
                                        queryFn: (q) => q
                                            .eqOrNull(
                                              'user_id',
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<PilotCertificatesViewRow>
                                  cTMainPilotCertificatesViewRowList =
                                  snapshot.data!;
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                                          ...
                                                          child:
                                                            ...
                                                            child:
                                                              ...
                                                              btnAction: (pilotId,
                                                                  ...
                                                                  docUrl,
                                                                  validity) async {
                                                                _model.insertPilotCertificate =
                                                                    await PilotCertificatesTable()
                                                                        .insert({
                                                                  'user_id':
                                                                      pilotId,
                                                                  'certificate_id':
                                                                      certificateId,
                                                                  'validity': supaSerialize<
                                                                          DateTime>(
                                                                      validity),
                                                                  'doc_url':
                                                                      docUrl,
                                      ...
                                      Padding(
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            final listPilotCertificates =
                                                cTMainPilotCertificatesViewRowList
                                                    .toList();
                                            if (listPilotCertificates.isEmpty) {
                                              return Center(
                                            ...
                                            return ListView.separated(
                                              ...
                                              itemCount:
                                                  listPilotCertificates.length,
                                              separatorBuilder: (_, __) =>
                                                  SizedBox(height: 16.0),
                                              itemBuilder: (context,
                                                  listPilotCertificatesIndex) {
                                                final listPilotCertificatesItem =
                                                    listPilotCertificates[
                                                        listPilotCertificatesIndex];
                                                return Container(
                                                  width: 100.0,
                                                  height: 120.0,
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      TextSpan(
                                                                        text: valueOrDefault<
                                                                          ...
                                                                          dateTimeFormat(
                                                                            "d/M/y",
                                                                            listPilotCertificatesItem.validity,
                                                                            locale:
                                                                      ...
                                                                      return Dialog(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            confirmBtnAction:
                                                                                () async {
                                                                              await PilotCertificatesTable().update(
                                                                                data: {
                                                                                  'is_deleted': true,
                                                                                },
                                                                                matchingRows: (rows) => rows.eqOrNull(
                                                                                  'id',
                                                                                  listPilotCertificatesItem.id,
                                                                                ),
                                                                              );
                                                                              await showDialog(
