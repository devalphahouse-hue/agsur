...
import 'modal_register_mechanic_shop_model.dart';
export 'modal_register_mechanic_shop_model.dart';

class ModalRegisterMechanicShopWidget extends StatefulWidget {
  const ModalRegisterMechanicShopWidget({super.key});

  @override
  State<ModalRegisterMechanicShopWidget> createState() =>
      _ModalRegisterMechanicShopWidgetState();
}

class _ModalRegisterMechanicShopWidgetState
    extends State<ModalRegisterMechanicShopWidget>
    with TickerProviderStateMixin {
  late ModalRegisterMechanicShopModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalRegisterMechanicShopModel());
    ...
    _model.tFOwnerTextController ??= TextEditingController();
    _model.tFOwnerFocusNode ??= FocusNode();
                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'Para criar uma conta para a oficina e liberar o acesso à plataforma, gere uma senha temporária',
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            Flexible(
                              child: TextFormField(
                                ...
                                cursorColor: FlutterFlowTheme.of(context)
                                    .secondaryBackground,
                                validator: _model.tFCityTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                cursorColor: FlutterFlowTheme.of(context)
                                    .secondaryBackground,
                                validator: _model
                                    .tFZipCodeTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ].divide(SizedBox(width: 8.0)),
                        ...
                        TextFormField(
                          controller: _model.tFOwnerTextController,
                          focusNode: _model.tFOwnerFocusNode,
                          autofocus: false,
                          obscureText: false,
                          decoration: InputDecoration(
                            isDense: false,
                          ...
                          cursorColor:
                              FlutterFlowTheme.of(context).secondaryBackground,
                          validator: _model.tFOwnerTextControllerValidator
                              .asValidator(context),
                        ),
                        TextFormField(
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              _model.formMechanic = true;
                              if (_model.formKey.currentState == null ||
                                  !_model.formKey.currentState!.validate()) {
                                safeSetState(() => _model.formMechanic = false);
                                return;
                              }
                              _shouldSetState = true;
                              _model.createAuthUserMechanic =
                              ...
                              _shouldSetState = true;
                              if ((_model.createAuthUserMechanic?.succeeded ??
                                  true)) {
                                _model.createUserMechanic =
                                    await UsersTable().insert({
                                  'id': getJsonField(
                                    (_model.createAuthUserMechanic?.jsonBody ??
                                        ''),
                                    r'''$.user.id''',
                                  ).toString(),
                                  ...
                                  'fullname': _model.tFNameTextController.text,
                                });
                                _shouldSetState = true;
                                ...
                                safeSetState(() {
                                  _model.tFNameTextController?.clear();
                                  _model.tFCpfTextController?.clear();
                                  _model.tFEmailTextController?.clear();
                                  _model.tFPhoneTextController?.clear();
                                  _model.tFCityTextController?.clear();
                                  _model.tFPasswordUserTextController?.clear();
                                  _model.tFZipCodeTextController?.clear();
                                  _model.tFOwnerTextController?.clear();
                                });
                                Navigator.pop(context);
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Erro'),
                                      content: Text(
                                          'Algo de errado! Não foi possível criar a conta da oficina, verique e tente novamente!'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
