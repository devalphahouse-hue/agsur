                ...
                children: [
                  ...
                  Expanded(
                    child: Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(
                          16.0, 24.0, 16.0, 24.0),
                      child: FutureBuilder<List<VwAllTrackingRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<VwAllTrackingRow>
                              cTTrackingsVwAllTrackingRowList = snapshot.data!;
                          ...
                          return Container(
                            ...
                            child: Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final listTrackings =
                                      cTTrackingsVwAllTrackingRowList.toList();
                                  if (listTrackings.isEmpty) {
                                    return Center(
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemCount: listTrackings.length,
                                    separatorBuilder: (_, __) =>
                                        SizedBox(height: 12.0),
                                    itemBuilder: (context, listTrackingsIndex) {
                                      final listTrackingsItem =
                                          listTrackings[listTrackingsIndex];
                                      return InkWell(
                                        splashColor: Colors.transparent,
                                        focusColor: Colors.transparent,
                                        hoverColor: Colors.transparent,
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              children: [
                                                                TextSpan(
                                                                  text: () {
                                                                    if (listTrackingsItem
                                                                            .userAircraftStatus ==
                                                                        'processing') {
                                                                      return 'Em processo';
                                                                    } else if (listTrackingsItem
                                                                            .userAircraftStatus ==
                                                                        'available') {
                                                                      return 'Disponível';
                                                                    } else {
