...
import 'modal_register_address_model.dart';
export 'modal_register_address_model.dart';

class ModalRegisterAddressWidget extends StatefulWidget {
  const ModalRegisterAddressWidget({
    super.key,
  ...
  final Future Function(
      ...
      String state,
      String complement,
      String companyId)? btnAction;

  @override
  State<ModalRegisterAddressWidget> createState() =>
      _ModalRegisterAddressWidgetState();
}

class _ModalRegisterAddressWidgetState extends State<ModalRegisterAddressWidget>
    with TickerProviderStateMixin {
  late ModalRegisterAddressModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalRegisterAddressModel());
                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'Adicione o endereço de fatura para esta proposta',
                      ...
                      children: [
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  _model.cep = await ViaCepCall.call(
                                    cep: _model.tFZipCodeTextController.text,
                                  );
                              ...
                              child: TextFormField(
                                ...
                                cursorColor: _model.validCep
                                    ? FlutterFlowTheme.of(context)
                                        .secondaryBackground
                                    : FlutterFlowTheme.of(context).alternate,
                                validator: _model.tFNeibhTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                            Expanded(
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              _model.formAddress = true;
                              if (_model.formKey.currentState == null ||
                                  !_model.formKey.currentState!.validate()) {
                                safeSetState(() => _model.formAddress = false);
                                return;
                              }
