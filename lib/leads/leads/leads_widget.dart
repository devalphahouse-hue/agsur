              ...
              Expanded(
                child: Padding(
                  ...
                  child: FutureBuilder<List<LeadsRow>>(
                    future:
                        (_model.requestCompleter ??= Completer<List<LeadsRow>>()
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Container(
                        ...
                        child: Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final listLeads = cTMainLeadsRowList.toList();
