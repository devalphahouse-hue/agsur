...
class ViewEditEmployeesWidget extends StatefulWidget {
  const ViewEditEmployeesWidget({
    super.key,
  ...
  static String routeName = 'ViewEditEmployees';
  static String routePath = '/viewEditEmployees';

  @override
  State<ViewEditEmployeesWidget> createState() =>
      _ViewEditEmployeesWidgetState();
}

class _ViewEditEmployeesWidgetState extends State<ViewEditEmployeesWidget> {
  late ViewEditEmployeesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewEditEmployeesModel());
