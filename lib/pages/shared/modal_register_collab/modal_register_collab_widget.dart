...
class _ModalRegisterCollabWidgetState extends State<ModalRegisterCollabWidget>
                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'Para criar uma conta para o piloto e liberar o acesso à plataforma, gere uma senha temporária',
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              _shouldSetState = true;
                              if ((_model.createAuthUserCollab?.succeeded ??
                                  true)) {
                                _model.createUserCollab =
                                    await UsersTable().insert({
                                  'id': CreateAccountAnotherUserCall.userID(
                                    (_model.createAuthUserCollab?.jsonBody ??
                                        ''),
                                  ),
                                  'name': _model.tFNameTextController.text,
                                  'email':
                                      CreateAccountAnotherUserCall.emailUser(
                                    (_model.createAuthUserCollab?.jsonBody ??
                                        ''),
                                  ),
                                ...
                                safeSetState(() {
                                  ...
                                  _model.tFCpfMask.clear();
                                  _model.tFLastNameTextController?.clear();
                                  _model.tFEmailTextController?.clear();
                                  _model.tFPhoneTextController?.clear();
                                  _model.tFPhoneMask.clear();
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Erro'),
                                      content: Text(
                                          'Algo de errado! Não foi possível criar a conta do colaborador, verique e tente novamente!'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
