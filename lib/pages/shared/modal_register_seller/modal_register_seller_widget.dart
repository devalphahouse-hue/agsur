...
class _ModalRegisterSellerWidgetState extends State<ModalRegisterSellerWidget>
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              _model.formSeller = true;
                              if (_model.formKey.currentState == null ||
                                  !_model.formKey.currentState!.validate()) {
                                safeSetState(() => _model.formSeller = false);
                                return;
                              }
                              _shouldSetState = true;
                              _model.createAuthUserSeller =
                              ...
                              _shouldSetState = true;
                              if ((_model.createAuthUserSeller?.succeeded ??
                                  true)) {
                                _model.createUserSeller =
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Erro'),
                                      content: Text(
                                          'Algo de errado! Não foi possível criar a conta do vendedor, verique e tente novamente!'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
