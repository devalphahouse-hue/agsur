                      ...
                      children: [
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                cursorColor: FlutterFlowTheme.of(context)
                                    .secondaryBackground,
                                validator: _model
                                    .tFEmpresaTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                            Expanded(
                              child: TextFormField(
                                ...
                                cursorColor: FlutterFlowTheme.of(context)
                                    .secondaryBackground,
                                validator: _model.tFCargoTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ].divide(SizedBox(width: 8.0)),
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              _model.formRLead = true;
                              if (_model.formKey.currentState == null ||
                                  !_model.formKey.currentState!.validate()) {
                                safeSetState(() => _model.formRLead = false);
                                return;
                              }
