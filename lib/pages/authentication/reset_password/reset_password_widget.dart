                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 12.0, 0.0, 12.0),
                              child: Text(
                                'Preencha os campos abaixo para receber o email de redefinição',
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: (_model.tFEmailTextController
                                                        .text ==
                                                    null ||
                                                _model.tFEmailTextController
                                                        .text ==
                                            ...
                                            ? null
                                            : () async {
                                                if (_model.tFEmailTextController
                                                    .text.isEmpty) {
                                                ...
                                                await showDialog(
                                                  ...
                                                  builder:
                                                    ...
                                                    return AlertDialog(
                                                      title: Text('Atenção!'),
                                                      content: Text(
                                                          'Caso não encontre o email, confira sua caixa de spam.'),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () =>
                                                              Navigator.pop(
                                        ...
                                        options: FFButtonOptions(
                                          ...
                                          borderRadius:
                                              BorderRadius.circular(12.0),
                                          disabledColor: Color(0x52807E7E),
                                          disabledTextColor:
                                              FlutterFlowTheme.of(context)
                                                  .primaryText,
                                        ),
