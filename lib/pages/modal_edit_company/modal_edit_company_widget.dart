...
class ModalEditCompanyWidget extends StatefulWidget {
  ...
  final Future Function(
      ...
      String? cpf,
      int? typeDoc,
      String? stateRegistration)? btnActions;
...
class _ModalEditCompanyWidgetState extends State<ModalEditCompanyWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (_model.getCompany?.firstOrNull?.typeDoc == '1') {
        _model.typeDoc = 1;
        safeSetState(() {});
      } else {
        _model.typeDoc = 2;
      ...
      safeSetState(() {
        _model.tFIncricCompanyTextController?.text =
            _model.getCompany!.firstOrNull!.stateRegistration!;
      });
    });
    ...
    _model.tFPhoneCompanyMask = MaskTextInputFormatter(mask: '(##) #####.####');
                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'Insira os dados abaixo para cadastrar a empresa',
                                ...
                                children: [
                                  if (_model.typeDoc == 2)
                                    TextFormField(
                                      ...
                                      focusNode: _model.tFCpfCompanyFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        isDense: false,
                                      ...
                                      cursorColor: FlutterFlowTheme.of(context)
                                          .secondaryBackground,
                                      validator: _model
                                          .tFCpfCompanyTextControllerValidator
                                          .asValidator(context),
                                      inputFormatters: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              if (_model.typeDoc == 1) {
                                safeSetState(() {
                                  _model.tFCpfCompanyTextController?.clear();
                                });
                              } else {
                                safeSetState(() {
                                  _model.tFCnpjCompanyTextController?.clear();
                                });
                              }

                              _model.formCollab = true;
                              if (_model.formKey.currentState == null ||
                                  !_model.formKey.currentState!.validate()) {
                                safeSetState(() => _model.formCollab = false);
                                return;
                              }
                              FFAppState().updateAsGetProposalDetailsStruct(
                                (e) => e
                                  ..updateProposalCompany(
                                    (e) => e
                                      ..typeDoc = _model.typeDoc.toString()
                                      ..cpf =
                                          _model.tFCpfCompanyTextController.text
                                      ..phone = _model
                                          .tFPhoneCompanyTextController.text
                                      ..cnpj = _model
