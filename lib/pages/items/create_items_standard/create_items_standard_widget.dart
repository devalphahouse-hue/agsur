...
class CreateItemsStandardWidget extends StatefulWidget {
  const CreateItemsStandardWidget({super.key});
...
class _CreateItemsStandardWidgetState extends State<CreateItemsStandardWidget> {
  ...
  void initState() {
    ...
    _model.tFQtyItemTextController ??= TextEditingController();
    _model.tFQtyItemFocusNode ??= FocusNode();
                    ...
                    Padding(
                      ...
                      child: FutureBuilder<List<CategoryRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<CategoryRow> cTCsrdAircraftCategoryRowList =
                              snapshot.data!;
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FlutterFlowDropDown<String>(
                                    controller:
                                        _model.dPDCategoryValueController ??=
                                            FormFieldController<String>(
                                      _model.dPDCategoryValue ??= '',
                                    ),
                                    options: List<String>.from(
                                        cTCsrdAircraftCategoryRowList
                                            .map((e) => e.id)
                                            .toList()),
                                    optionLabels: cTCsrdAircraftCategoryRowList
                                        .map((e) => e.categoryName)
                                        .toList(),
                                    onChanged: (val) => safeSetState(
                                        () => _model.dPDCategoryValue = val),
                                    height: 48.0,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.tFQtyItemTextController,
                                          focusNode: _model.tFQtyItemFocusNode,
                                          autofocus: false,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            isDense: false,
                                          ...
                                          cursorColor:
                                              FlutterFlowTheme.of(context)
                                                  .primaryText,
                                          validator: _model
                                              .tFQtyItemTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                        ...
                                        onPressed: () async {
                                          _model.createItemSeries =
                                            ...
                                            'item_name': _model
                                                .tFAircraftNameTextController
                                                .text,
                                            'qty': int.tryParse(_model
                                                .tFQtyItemTextController.text),
                                            'price': 0.00,
                                          ...
                                          await Future.wait([
                                            Future(() async {
                                              safeSetState(() {
                                                _model
                                                    .dPDCategoryValueController
                                                    ?.reset();
                                                _model.dPDCategoryValue = null;
                                              });
                                            }),
                                            Future(() async {
                                              safeSetState(() {
                                          ...
                                          ScaffoldMessenger.of(context)
                                            ...
                                            SnackBar(
                                              content: Text(
                                                'Item de série cadastrado com sucesso!',
                                                style: TextStyle(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 12.0, 0.0, 12.0),
                                child: FutureBuilder<List<AircraftItemsRow>>(
                                  future: AircraftItemsTable().queryRows(
                                    queryFn: (q) => q
                                        .eqOrNull(
                                          'item_type',
